...
class Mega:
    ...
    def download(self, file, dest_path=None, dest_filename=None, progress_callback=None):
        """
        Download a file by its file object with optional progress callback.
        """
    ...
    def download_url(self, url, dest_path=None, dest_filename=None, progress_callback=None): 
        """
        Download a file by its public URL, with an optional progress callback.
        """
        path = self._parse_url(url).split('!')
        file_id = path[0]
        file_key = path[1]
        
        # Llamada a la función _download_file con el callback de progreso
        return self._download_file(
            ...
            dest_filename=dest_filename,
            is_public=True,
            progress_callback=progress_callback  # Añadimos el parámetro de progreso
        )
    ...
    def _download_file(self, 
                   ...
                   is_public=False,
                   file=None,
                   progress_callback=None):  # Añadimos progress_callback
        ...
        with tempfile.NamedTemporaryFile(mode='w+b',
            ...
            tamano_descargado = 0  # Para el progreso
            ...
            for chunk_start, chunk_size in get_chunks(file_size):
                ...
                tamano_descargado += chunk_size
                if progress_callback:
                    progress_callback(tamano_descargado, file_size)  # Llamada al callback
